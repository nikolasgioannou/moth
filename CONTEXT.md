...
**Slug**:
The readable part of a ticket's filename, derived from its title. Re-synced when moth changes the title, so it does not drift. Never authoritative; the id is.
