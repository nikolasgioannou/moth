...
- [ ] Querying the schema returns every legal field, every state with its category, and every priority value
...
- [ ] A ticket whose state is absent from config is reported when read
