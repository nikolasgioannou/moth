...
updated_at: 2026-08-31T00:02:22.258Z
---
...
- [x] The spec's command surface section matches what the binary accepts
- [x] A decision on noun-verb is recorded, either as built or as explicitly out of scope
- [x] The `--json` claim is either true of every read command or narrowed to name the exception
